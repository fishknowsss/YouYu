...
const stateConfig: Record<DesktopPetState, StateConfig> = {
  ...
  edgeLeftBlink: { atlas: 'extra', rowKey: 'edgeBlink', frameIndexes: [0, 1, 2], fps: 6, loop: false },
  edgeRightBlink: { atlas: 'extra', rowKey: 'edgeBlink', frameIndexes: [0, 1, 2], fps: 6, loop: false },
  ...
  bottomDizzy: { atlas: 'extra', rowKey: 'fallRecover', frameIndexes: [3, 4], fps: 5, loop: false },
  bottomAngry: { atlas: 'extra', rowKey: 'annoyed', frameIndexes: [3, 4], fps: 5, loop: false },
